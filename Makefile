...
ACLOCAL = ${SHELL} /home/darek/Desktop/opensmile-2.3.0/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
ANDROID_LDFLAGS = 
AR = ar
AUTOCONF = ${SHELL} /home/darek/Desktop/opensmile-2.3.0/missing autoconf
AUTOHEADER = ${SHELL} /home/darek/Desktop/opensmile-2.3.0/missing autoheader
AUTOMAKE = ${SHELL} /home/darek/Desktop/opensmile-2.3.0/missing automake-1.15
AWK = mawk
CC = gcc
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /home/darek/Desktop/opensmile-2.3.0/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
STRIP = strip
VERSION = 2.3.0
abs_builddir = /home/darek/Desktop/opensmile-2.3.0
abs_srcdir = /home/darek/Desktop/opensmile-2.3.0
abs_top_builddir = /home/darek/Desktop/opensmile-2.3.0
abs_top_srcdir = /home/darek/Desktop/opensmile-2.3.0
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/darek/Desktop/opensmile-2.3.0/install-sh
...
pdfdir = ${docdir}
prefix = /home/darek/Desktop/opensmile-2.3.0/inst
...
include progsrc/smilextract/$(DEPDIR)/SMILExtract-SMILExtract.Po
include src/android/$(DEPDIR)/libopensmile_la-jniMessageInterface.Plo
include src/android/$(DEPDIR)/libopensmile_la-openslesSource.Plo
include src/classifiers/$(DEPDIR)/libopensmile_la-libsvmliveSink.Plo
include src/classifiers/$(DEPDIR)/libopensmile_la-svmSink.Plo
include src/classifiers/julius/$(DEPDIR)/libopensmile_la-juliusSink.Plo
include src/classifiers/libsvm/$(DEPDIR)/libopensmile_la-svm.Plo
include src/core/$(DEPDIR)/libopensmile_la-commandlineParser.Plo
include src/core/$(DEPDIR)/libopensmile_la-componentManager.Plo
include src/core/$(DEPDIR)/libopensmile_la-configManager.Plo
include src/core/$(DEPDIR)/libopensmile_la-dataMemory.Plo
include src/core/$(DEPDIR)/libopensmile_la-dataProcessor.Plo
include src/core/$(DEPDIR)/libopensmile_la-dataReader.Plo
include src/core/$(DEPDIR)/libopensmile_la-dataSelector.Plo
include src/core/$(DEPDIR)/libopensmile_la-dataSink.Plo
include src/core/$(DEPDIR)/libopensmile_la-dataSource.Plo
include src/core/$(DEPDIR)/libopensmile_la-dataWriter.Plo
include src/core/$(DEPDIR)/libopensmile_la-exceptions.Plo
include src/core/$(DEPDIR)/libopensmile_la-nullSink.Plo
include src/core/$(DEPDIR)/libopensmile_la-smileCommon.Plo
include src/core/$(DEPDIR)/libopensmile_la-smileComponent.Plo
include src/core/$(DEPDIR)/libopensmile_la-smileLogger.Plo
include src/core/$(DEPDIR)/libopensmile_la-vecToWinProcessor.Plo
include src/core/$(DEPDIR)/libopensmile_la-vectorProcessor.Plo
include src/core/$(DEPDIR)/libopensmile_la-vectorTransform.Plo
include src/core/$(DEPDIR)/libopensmile_la-winToVecProcessor.Plo
include src/core/$(DEPDIR)/libopensmile_la-windowProcessor.Plo
include src/dsp/$(DEPDIR)/libopensmile_la-dbA.Plo
include src/dsp/$(DEPDIR)/libopensmile_la-signalGenerator.Plo
include src/dsp/$(DEPDIR)/libopensmile_la-smileResample.Plo
include src/dsp/$(DEPDIR)/libopensmile_la-specResample.Plo
include src/dsp/$(DEPDIR)/libopensmile_la-specScale.Plo
include src/dsp/$(DEPDIR)/libopensmile_la-vadV1.Plo
include src/dspcore/$(DEPDIR)/libopensmile_la-acf.Plo
include src/dspcore/$(DEPDIR)/libopensmile_la-amdf.Plo
include src/dspcore/$(DEPDIR)/libopensmile_la-contourSmoother.Plo
include src/dspcore/$(DEPDIR)/libopensmile_la-deltaRegression.Plo
include src/dspcore/$(DEPDIR)/libopensmile_la-fftmagphase.Plo
include src/dspcore/$(DEPDIR)/libopensmile_la-fftsg.Plo
include src/dspcore/$(DEPDIR)/libopensmile_la-framer.Plo
include src/dspcore/$(DEPDIR)/libopensmile_la-fullinputMean.Plo
include src/dspcore/$(DEPDIR)/libopensmile_la-fullturnMean.Plo
include src/dspcore/$(DEPDIR)/libopensmile_la-monoMixdown.Plo
include src/dspcore/$(DEPDIR)/libopensmile_la-preemphasis.Plo
include src/dspcore/$(DEPDIR)/libopensmile_la-transformFft.Plo
include src/dspcore/$(DEPDIR)/libopensmile_la-turnDetector.Plo
include src/dspcore/$(DEPDIR)/libopensmile_la-vectorMVN.Plo
include src/dspcore/$(DEPDIR)/libopensmile_la-vectorPreemphasis.Plo
include src/dspcore/$(DEPDIR)/libopensmile_la-windower.Plo
include src/examples/$(DEPDIR)/libopensmile_la-exampleSink.Plo
include src/examples/$(DEPDIR)/libopensmile_la-exampleSource.Plo
include src/examples/$(DEPDIR)/libopensmile_la-simpleMessageSender.Plo
include src/functionals/$(DEPDIR)/libopensmile_la-functionalComponent.Plo
include src/functionals/$(DEPDIR)/libopensmile_la-functionalCrossings.Plo
include src/functionals/$(DEPDIR)/libopensmile_la-functionalDCT.Plo
include src/functionals/$(DEPDIR)/libopensmile_la-functionalExtremes.Plo
include src/functionals/$(DEPDIR)/libopensmile_la-functionalLpc.Plo
include src/functionals/$(DEPDIR)/libopensmile_la-functionalMeans.Plo
include src/functionals/$(DEPDIR)/libopensmile_la-functionalMoments.Plo
include src/functionals/$(DEPDIR)/libopensmile_la-functionalOnset.Plo
include src/functionals/$(DEPDIR)/libopensmile_la-functionalPeaks.Plo
include src/functionals/$(DEPDIR)/libopensmile_la-functionalPeaks2.Plo
include src/functionals/$(DEPDIR)/libopensmile_la-functionalPercentiles.Plo
include src/functionals/$(DEPDIR)/libopensmile_la-functionalRegression.Plo
include src/functionals/$(DEPDIR)/libopensmile_la-functionalSamples.Plo
include src/functionals/$(DEPDIR)/libopensmile_la-functionalSegments.Plo
include src/functionals/$(DEPDIR)/libopensmile_la-functionalTimes.Plo
include src/functionals/$(DEPDIR)/libopensmile_la-functionals.Plo
include src/io/$(DEPDIR)/libopensmile_la-libsvmSink.Plo
include src/iocore/$(DEPDIR)/libopensmile_la-arffSink.Plo
include src/iocore/$(DEPDIR)/libopensmile_la-arffSource.Plo
include src/iocore/$(DEPDIR)/libopensmile_la-csvSink.Plo
include src/iocore/$(DEPDIR)/libopensmile_la-csvSource.Plo
include src/iocore/$(DEPDIR)/libopensmile_la-datadumpSink.Plo
include src/iocore/$(DEPDIR)/libopensmile_la-htkSink.Plo
include src/iocore/$(DEPDIR)/libopensmile_la-htkSource.Plo
include src/iocore/$(DEPDIR)/libopensmile_la-waveSink.Plo
include src/iocore/$(DEPDIR)/libopensmile_la-waveSinkCut.Plo
include src/iocore/$(DEPDIR)/libopensmile_la-waveSource.Plo
include src/lld/$(DEPDIR)/libopensmile_la-cens.Plo
include src/lld/$(DEPDIR)/libopensmile_la-chroma.Plo
include src/lld/$(DEPDIR)/libopensmile_la-formantLpc.Plo
include src/lld/$(DEPDIR)/libopensmile_la-formantSmoother.Plo
include src/lld/$(DEPDIR)/libopensmile_la-harmonics.Plo
include src/lld/$(DEPDIR)/libopensmile_la-lpc.Plo
include src/lld/$(DEPDIR)/libopensmile_la-lsp.Plo
include src/lld/$(DEPDIR)/libopensmile_la-pitchDirection.Plo
include src/lld/$(DEPDIR)/libopensmile_la-pitchJitter.Plo
include src/lld/$(DEPDIR)/libopensmile_la-pitchShs.Plo
include src/lld/$(DEPDIR)/libopensmile_la-pitchSmootherViterbi.Plo
include src/lld/$(DEPDIR)/libopensmile_la-tonefilt.Plo
include src/lld/$(DEPDIR)/libopensmile_la-tonespec.Plo
include src/lldcore/$(DEPDIR)/libopensmile_la-energy.Plo
include src/lldcore/$(DEPDIR)/libopensmile_la-intensity.Plo
include src/lldcore/$(DEPDIR)/libopensmile_la-melspec.Plo
include src/lldcore/$(DEPDIR)/libopensmile_la-mfcc.Plo
include src/lldcore/$(DEPDIR)/libopensmile_la-mzcr.Plo
include src/lldcore/$(DEPDIR)/libopensmile_la-pitchACF.Plo
include src/lldcore/$(DEPDIR)/libopensmile_la-pitchBase.Plo
include src/lldcore/$(DEPDIR)/libopensmile_la-pitchSmoother.Plo
include src/lldcore/$(DEPDIR)/libopensmile_la-plp.Plo
include src/lldcore/$(DEPDIR)/libopensmile_la-spectral.Plo
include src/other/$(DEPDIR)/libopensmile_la-bowProducer.Plo
include src/other/$(DEPDIR)/libopensmile_la-maxIndex.Plo
include src/other/$(DEPDIR)/libopensmile_la-valbasedSelector.Plo
include src/other/$(DEPDIR)/libopensmile_la-vectorConcat.Plo
include src/other/$(DEPDIR)/libopensmile_la-vectorOperation.Plo
include src/portaudio/$(DEPDIR)/libopensmile_la-portaudioDuplex.Plo
include src/portaudio/$(DEPDIR)/libopensmile_la-portaudioSink.Plo
include src/portaudio/$(DEPDIR)/libopensmile_la-portaudioSource.Plo
include src/portaudio/$(DEPDIR)/libopensmile_la-portaudioWavplayer.Plo
include src/rnn/$(DEPDIR)/libopensmile_la-rnn.Plo
include src/rnn/$(DEPDIR)/libopensmile_la-rnnProcessor.Plo
include src/rnn/$(DEPDIR)/libopensmile_la-rnnSink.Plo
include src/rnn/$(DEPDIR)/libopensmile_la-rnnVad2.Plo
include src/smileutil/$(DEPDIR)/libopensmile_la-smileUtil.Plo
include src/smileutil/$(DEPDIR)/libopensmile_la-smileUtilSpline.Plo
include src/smileutil/$(DEPDIR)/libopensmile_la-zerosolve.Plo
include src/video/$(DEPDIR)/libopensmile_la-openCVSource.Plo
...
distclean: distclean-am
	...
	-rm -rf progsrc/smilextract/$(DEPDIR) src/android/$(DEPDIR) src/classifiers/$(DEPDIR) src/classifiers/julius/$(DEPDIR) src/classifiers/libsvm/$(DEPDIR) src/core/$(DEPDIR) src/dsp/$(DEPDIR) src/dspcore/$(DEPDIR) src/examples/$(DEPDIR) src/functionals/$(DEPDIR) src/io/$(DEPDIR) src/iocore/$(DEPDIR) src/lld/$(DEPDIR) src/lldcore/$(DEPDIR) src/other/$(DEPDIR) src/portaudio/$(DEPDIR) src/rnn/$(DEPDIR) src/smileutil/$(DEPDIR) src/video/$(DEPDIR)
	-rm -f Makefile
